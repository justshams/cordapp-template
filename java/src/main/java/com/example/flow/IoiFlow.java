 ...
 * to come to an agreement about some arbitrary data (in this case, a [IntentionOfInterest]) encapsulated within a [DealState].
 *
 ...
 */
public class IoIFlow {
    public static class Initiator extends FlowLogic<IoIFlowResult> {

        private final IndicationOfInterestState indicationOfInterestState;
        ...
        public Initiator(IndicationOfInterestState indicationOfInterestState, Party otherParty) {
            this.indicationOfInterestState = indicationOfInterestState;
         ...
         */
        @Suspendable
        @Override public IoIFlowResult call() {
            ...
            try {
                ...
                final TransactionState offerMessage = new TransactionState<ContractState>(indicationOfInterestState, notary);
                ...
                send(otherParty, ntx);
                return new IoIFlowResult.Success(String.format("Transaction id %s committed to ledger.", ntx.getId()));
            } catch(Exception ex) {
                // Just catch all exception types.
                return new IoIFlowResult.Failure(ex.getMessage());
            }
        }
    }

    public static class Acceptor extends FlowLogic<IoIFlowResult> {
    ...
    public static class IoIFlowResult {
        public static class Success extends IoIFlow.IoIFlowResult {
        ...
        public static class Failure extends IoIFlow.IoIFlowResult {
            private String message;
