 ...
 */
public class IndicationOfInterestState implements DealState {
    private final IndicationOfInterest indicationOfInterest;
    private final Party buyer;
    private final Party seller;
    private final IndicationOfInterestContract contract;
    private final UniqueIdentifier linearId;

    public IndicationOfInterestState(IndicationOfInterest indicationOfInterest,
                                     Party buyer,
                                     Party seller,
                                     IndicationOfInterestContract contract)
    {
        ...
        this.linearId = new UniqueIdentifier(
                Integer.toString(indicationOfInterest.getId()),
                UUID.randomUUID());
    }

    public IndicationOfInterest getIndicationOfInterest() { return indicationOfInterest; }
    public Party getBuyer() { return buyer; }
    public Party getSeller() { return seller; }
    @Override public IndicationOfInterestContract getContract() { return contract; }
